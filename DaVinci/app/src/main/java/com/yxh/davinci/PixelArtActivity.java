...
import com.yxh.davinci.ImageAnalysisAbility.ImageToPixelArt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(PixelArtActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(PixelArtActivity.this, new String[]{ Manifest.permission. WRITE_EXTERNAL_STORAGE }, 1);
                } else {
                    openAlbum();
                }
            }
